...
def print_board(board: Board) -> None:
    """Print the board without cages to the console.

    :param board: The board to print
    """
    # Transponer el tablero para corregir la impresión
    transposed_board = [[board[x][y] for x in range(9)] for y in range(9)]
